...
var handleVisitorsDonutChart = function() {
    ...
    Morris.Donut({
        ...
        data: [
            {label: "Novos", value: chartNovos},
            {label: "Retornaram", value: chartRetornaram}
        ],
        colors: [green, blue],
...
var DashboardV2 = function () {
    ...
    return {
        //main function
        init: function () {
            $.getScript('assets/admin/plugins/morris/raphael.min.js').done(function() {
                $.getScript('assets/admin/plugins/morris/morris.js').done(function() {
            ...
            $.getScript('assets/admin/plugins/jquery-jvectormap/jquery-jvectormap-1.2.2.min.js').done(function() {
                $.getScript('assets/admin/plugins/jquery-jvectormap/jquery-jvectormap-world-merc-en.js').done(function() {
                    handleVisitorsVectorMap();
                });
            });
            
            $.getScript('assets/admin/plugins/bootstrap-calendar/js/bootstrap_calendar.min.js').done(function() {
                handleScheduleCalendar();
            });
            
            $.getScript('assets/admin/plugins/gritter/js/jquery.gritter.js').done(function() {
