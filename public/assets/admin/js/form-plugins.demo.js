...
var FormPlugins = function () {
    ...
    return {
        ...
        init: function () {
              ...
              $.getScript('/assets/admin/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js').done(function() {
                handleDatepicker();
            });
           
            $.getScript('/assets/admin/plugins/ionRangeSlider/js/ion-rangeSlider/ion.rangeSlider.min.js').done(function() {
               handleIonRangeSlider();
            });
            
            $.getScript('/assets/admin/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js').done(function() {
               handleFormColorPicker();
           });
           
            $.getScript('/assets/admin/plugins/masked-input/masked-input.min.js').done(function() {
               handleFormMaskedInput();
           });
           
            $.getScript('/assets/admin/plugins/bootstrap-timepicker/js/bootstrap-timepicker.min.js').done(function() {
               handleFormTimePicker();
            });
            
            $.getScript('/assets/admin/plugins/password-indicator/js/password-indicator.js').done(function() {
               handleFormPasswordIndicator();
            });
            
            $.getScript('/assets/admin/plugins/bootstrap-combobox/js/bootstrap-combobox.js').done(function() {
               handleBootstrapCombobox();
            });
            
            $.getScript('/assets/admin/plugins/bootstrap-select/bootstrap-select.min.js').done(function() {
               handleSelectpicker();
            });
            
            $.getScript('/assets/admin/plugins/bootstrap-tagsinput/bootstrap-tagsinput.min.js').done(function() {
               handleTagsInput();
            });
            
            $.getScript('/assets/admin/plugins/bootstrap-tagsinput/bootstrap-tagsinput-typeahead.js').done(function() {
               handleJqueryAutocomplete();
            });
            
            $.getScript('/assets/admin/plugins/jquery-tag-it/js/tag-it.min.js').done(function() {
               handleJqueryTagIt();
            });
            
            $.getScript('/assets/admin/plugins/bootstrap-daterangepicker/moment.js').done(function() {
                $.getScript('/assets/admin/plugins/bootstrap-daterangepicker/daterangepicker.js').done(function() {
                    handleDateRangePicker();
                });
            });
            
            $.getScript('/assets/admin/plugins/select2/dist/js/select2.min.js').done(function() {
                handleSelect2();
            });
            
            $.getScript('/assets/admin/plugins/bootstrap-eonasdan-datetimepicker/build/js/bootstrap-datetimepicker.min.js').done(function() {
